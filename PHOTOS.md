...
| `08-galeria.jpg` | Instagram (rodapé da página) | Vertical | ✅ Real (Instagram) |
| `11-galeria.jpg` | Instagram (rodapé da página) | Vertical | ✅ Real (Instagram) |
| `15-video-poster.jpg` | Capa/poster do vídeo na seção "Em vídeo" (aparece antes de dar play) | Vertical 9:16 | ✅ Real (frame de abertura do próprio vídeo) |
...
A antiga seção "Galeria" virou a seção **"Em vídeo"**: em vez de um mosaico de fotos, ela mostra o vídeo completo do Reel do Instagram @pilatestatiananobre (`assets/video/tatiana-aula.mp4`), com play/pause e áudio — o visitante clica para assistir. As fotos `08-galeria.jpg` e `11-galeria.jpg`, que antes apareciam nessa seção, continuam no site normalmente na vitrine "Instagram" lá no rodapé. Para trocar o vídeo por outro, basta substituir o arquivo mantendo o mesmo nome (formato `.mp4`, H.264/AAC, o formato mais compatível com navegadores).
